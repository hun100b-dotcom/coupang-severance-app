            ...
            <div key={step.num} style={{ display: 'flex', alignItems: 'center', flex: 1, minWidth: 80 }}>
              ...
              >
                <div style={{
                  ...
                  background: formStep === step.num ? '#3182f6' : formStep > step.num ? 'rgba(49,200,100,0.25)' : 'rgba(255,255,255,0.08)',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 340px', gap: 32, alignItems: 'start' }}>
          <div style={{
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <p style={{ margin: '4px 0 0', fontSize: '0.78rem', color: 'rgba(255,255,255,0.35)' }}>{STEPS[formStep - 1].desc}</p>
            </div>
                      ...
                      return (
                        <button key={tag} type="button"
                          ...
                          style={{
                            ...
                            background: sel ? '#3182f6' : 'rgba(255,255,255,0.08)',
          ...
          <div style={{ position: 'sticky', top: 24 }}>
            ...
            <div style={{
              ...
              border: `1px solid ${form.section !== 'always' ? 'rgba(240,68,82,0.3)' : 'rgba(255,255,255,0.1)'}`,
              ...
              <div style={{ fontWeight: 900, fontSize: '1.05rem', color: '#fff', lineHeight: 1.3 }}>
              ...
              <div key={job.id} style={{
                ...
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center' }}>
                  ...
                  <span style={{
                    ...
                    background: job.status === 'active' ? 'rgba(49,200,100,0.18)' : job.status === 'draft' ? 'rgba(255,180,0,0.18)' : 'rgba(255,255,255,0.08)',
                    color: job.status === 'active' ? '#3fc878' : job.status === 'draft' ? '#ffb400' : 'rgba(255,255,255,0.35)',
                  }}>
                ...
                {/* 회사명 + 센터명 */}
                <div>
                  <div style={{ fontWeight: 900, fontSize: '1.05rem', color: '#fff', wordBreak: 'break-word' }}>{job.company_name}</div>
                  <div style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.55)', marginTop: 3, wordBreak: 'break-word' }}>{job.center_name}</div>
                </div>

                {/* 지역 */}
                <div style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.45)' }}>📍 {job.region}</div>
                ...
                {/* 근무 정보 */}
                <div style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.4)', display: 'flex', gap: 14, flexWrap: 'wrap' }}>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  <span style={{ fontSize: '0.72rem', padding: '2px 8px', borderRadius: 999, background: 'rgba(255,255,255,0.07)', color: 'rgba(255,255,255,0.45)' }}>
                    👁 {job.view_count ?? 0}회 조회
                  </span>
                  <span style={{ fontSize: '0.72rem', padding: '2px 8px', borderRadius: 999, background: appCount > 0 ? 'rgba(49,130,246,0.15)' : 'rgba(255,255,255,0.07)', color: appCount > 0 ? '#3182f6' : 'rgba(255,255,255,0.45)' }}>
                    📋 {appCount}명 지원
                  </span>
                </div>
                ...
                {benefits.length > 0 && (
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5 }}>
                    {benefits.slice(0, 4).map(b => (
                      <span key={b} style={{ padding: '3px 9px', borderRadius: 999, fontSize: '0.7rem', fontWeight: 600, background: 'rgba(255,255,255,0.07)', color: 'rgba(255,255,255,0.5)' }}>{b}</span>
                    ))}
                    {benefits.length > 4 && <span style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.3)', padding: '3px 0' }}>+{benefits.length - 4}</span>}
                  </div>
                )}
