          ...
          <div className="w-full px-5 flex justify-between items-center mb-1 h-14">
            {currentView === 'main' ? (
              <div className="flex flex-col ml-1">
                <span className="text-[#3182F6] font-extrabold text-[12px] mb-0.5 flex items-center gap-1 tracking-wide">
              ...
              <div className="flex items-center gap-1 -ml-1">
                ...
                <h2 className="text-[20px] font-extrabold tracking-tight text-[#191F28] ml-1">
                  {currentView === 'form' ? '1:1 문의 남기기' : '문의 접수 완료'}
                </h2>
              </div>
            )}
            <button
          ...
          {currentView === 'main' && (
            <div className="flex-1 flex flex-col px-5 pb-12 pt-5">
              ...
              <button
                ...
                className="w-full mb-8 bg-white hover:bg-gray-50 transition-colors border border-gray-100 rounded-[24px] p-5 flex items-center justify-between active:scale-[0.98] shadow-[0_4px_20px_rgba(0,0,0,0.03)] group"
              >
                <div className="flex items-center gap-4">
                  <div className="bg-gray-100 w-12 h-12 rounded-[16px] flex items-center justify-center border border-gray-200 shadow-inner group-hover:bg-blue-50 transition-colors">
                    <Mail className="w-6 h-6 text-[#191F28] group-hover:text-blue-600 transition-colors" />
                  </div>
                  <div className="text-left">
                    <h4 className="text-[16px] font-extrabold text-[#191F28] tracking-tight group-hover:text-blue-600 transition-colors font-sans">1:1 문의 남기기</h4>
                    <p className="text-[13px] text-gray-500 font-medium tracking-tight mt-0.5 font-sans">앱 내에서 빠르고 안전하게 문의하세요</p>
                  </div>
                </div>
                <div className="w-8 h-8 rounded-full bg-gray-50 border border-gray-100 flex items-center justify-center group-hover:bg-blue-50 transition-colors">
            ...
            <div className="flex-1 flex flex-col px-5 pt-6 pb-8 min-h-0">
              <div className="bg-blue-50/80 p-4 rounded-2xl border border-blue-100 mb-6 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-gray-600 font-medium leading-relaxed tracking-tight font-sans">분류를 선택해주시면 담당자가 확인 후 24시간 내에 답변해 드립니다.</p>
                </div>
              </div>
              <div className="mb-6">
