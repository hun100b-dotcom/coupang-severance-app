// 나의 혜택 페이지 — 일용직 근로자가 받을 수 있는 지원금·수당 뉴스레터
...
const BENEFITS: Benefit[] = [
  ...
  },
  {
    ...
    emoji: '⚖️',
    title: '임금체불 구제',
    subtitle: '체당금 제도로 최대 2,100만원 선지급',
    tag: '권리 구제',
  ...
  return (
    <div className="min-h-screen bg-[#F2F4F6] pb-10">
      ...
      <main className="max-w-[460px] mx-auto px-4 pt-5 space-y-4">
        {/* 상단 배너 */}
        <div className="rounded-[28px] bg-gradient-to-br from-violet-500 to-violet-700 p-5 text-white">
        ...
        <div className="space-y-3">
          {BENEFITS.map((benefit, idx) => (
            <motion.button
              ...
              className="w-full bg-white rounded-[28px] shadow-[0_8px_30px_rgba(15,23,42,0.06)] border border-slate-100 px-4 py-4 text-left flex items-center gap-3 hover:shadow-[0_12px_40px_rgba(15,23,42,0.10)] transition-all active:scale-[0.98]"
      ...
      <AnimatePresence>
        {selectedBenefit && (
          ...
          >
            ...
            />
            <motion.div
              className="relative w-full max-w-md bg-white rounded-t-[32px] sm:rounded-[32px] shadow-2xl overflow-hidden flex flex-col max-h-[85vh]"
            ...
            >
              ...
              <div className="flex items-center justify-between px-5 pt-5 pb-4 border-b border-slate-100">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-2xl bg-slate-50 flex items-center justify-center text-2xl">
              ...
              <div className="overflow-y-auto flex-1 px-5 py-5 space-y-4">
                ...
                {[
                  ...
                  <div key={item.label} className="rounded-2xl bg-slate-50 px-4 py-3 space-y-1">
