// LandingV1 — 밝은(Light) 테마 전체 통일 (/v1 라우트)
// 전체 배경: 흰색/밝은 회색 계열, 텍스트: 어두운 색
...
export default function LandingV1() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (navRef.current) {
        // 밝은 테마: 스크롤 시 흰색 불투명도 증가
        navRef.current.style.background =
          window.scrollY > 80
            ? 'rgba(255,255,255,0.97)'
            : 'rgba(255,255,255,0.90)'
        navRef.current.style.boxShadow =
          window.scrollY > 80 ? '0 2px 16px rgba(0,0,0,0.08)' : 'none'
      }
    }
  ...
  return (
    ...
    >
        ...
        <div className="relative w-full max-w-[1100px] mx-auto px-6" style={{ zIndex: 1 }}>
          ...
          <Reveal delay={0.1}>
            ...
            <h1
              ...
              style={{ fontSize: 'clamp(40px, 8vw, 80px)', color: '#111827' }}
            >
              당신이 받아야 할 돈,
              <br />
              아직 거기 있습니다.
          ...
          <Reveal delay={0.2}>
            ...
            <p
              ...
              style={{ fontSize: 'clamp(16px, 2.5vw, 20px)', color: '#374151' }}
            >
              퇴직금·실업급여·주휴수당·연차수당—
              <br />
      ...
      {/* ② PAIN — 밝은 슬레이트 배경 ──────────────────────────────────────── */}
      <section id="pain" className="relative z-[1]" style={{ padding: '120px 0', background: '#f8fafc' }}>
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          <Reveal delay={0.1}>
            <p className="text-[17px] leading-[1.7] max-w-[600px] mb-8" style={{ color: '#374151' }}>
            ...
            {[
              ...
              <Reveal key={item.num} delay={0.1 + i * 0.1}>
                ...
                >
                  ...
                  <div className="text-[15px] leading-[1.5]" style={{ color: '#374151' }}>
                    {item.label}
                  </div>
                </div>
              </Reveal>
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          <Reveal>
            <div className="text-center max-w-[600px] mx-auto mb-[70px]">
              ...
              <p className="text-[17px] leading-[1.7]" style={{ color: '#374151' }}>
            ...
            {[
              ...
              <Reveal key={card.title} delay={0.1 + i * 0.1}>
                ...
                >
                  ...
                  <h3 className="text-[20px] font-bold mb-3" style={{ color: '#111827' }}>{card.title}</h3>
                  <p className="text-[15px] leading-[1.65]" style={{ color: '#374151' }}>
                    {card.desc}
                  </p>
                  {/* 뱃지 */}
                  <span
      ...
      {/* ④ HOW — 밝은 슬레이트 배경 ──────────────────────────────────────────── */}
      <section id="how" className="relative z-[1]" style={{ padding: '120px 0', background: '#f1f5f9' }}>
        <div className="max-w-[1100px] mx-auto px-6">
          {/* 섹션 헤더 */}
          <Reveal>
            ...
            {[
              ...
              <Reveal key={step.num} delay={0.1 + i * 0.1}>
                <div className="text-center px-6 py-10 relative">
                  ...
                  <h3 className="text-[18px] font-bold mb-3" style={{ color: '#111827' }}>{step.title}</h3>
                  <p className="text-[14px] leading-[1.65] whitespace-pre-line" style={{ color: '#374151' }}>
                    {step.desc}
                  </p>
                </div>
              </Reveal>
          ...
          <div className="grid md:grid-cols-2 gap-[80px] items-center">
                ...
                {[
                  ...
                  <Reveal key={item.title} delay={item.delay}>
                    <li className="flex gap-4 items-start">
                      ...
                      <div>
                        <strong className="block text-[16px] font-bold mb-1" style={{ color: '#111827' }}>{item.title}</strong>
            ...
            <Reveal delay={0.2}>
              ...
              >
                ...
                <p className="text-[18px] mb-10" style={{ color: '#374151' }}>
                  근무일 이상이면 퇴직금 수령 가능
                </p>
                {/* 구분선 */}
                <div
                ...
                <div className="grid grid-cols-2 gap-5">
                  {[
                    ...
                    >
                      <div className="text-[28px] font-black mb-1" style={{ color: '#111827' }}>{stat.num}</div>
        ...
        <div className="max-w-[700px] mx-auto px-6">
          ...
          <Reveal delay={0.1}>
            <h2
              ...
              style={{ fontSize: 'clamp(32px, 5vw, 52px)', color: '#111827' }}
            >
              당신이 받아야 할 돈,
              <br />
          ...
          <Reveal delay={0.2}>
            <p className="text-[18px] leading-[1.7] mb-12" style={{ color: '#374151' }}>
