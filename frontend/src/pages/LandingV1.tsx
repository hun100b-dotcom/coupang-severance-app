          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-[80px] items-center">
            <div>
              ...
              <ul className="flex flex-col gap-5">
                {[
                  // WHY①: 감성/가치 제안 — STATS와 중복 피하기 위해 알고리즘 정체성 강조
                  { title: '국가공인 28일 블록 알고리즘', desc: '고용노동부 기준의 28일 블록 알고리즘으로 법정 퇴직금을 정확히 계산합니다.', delay: 0.1 },
                  // WHY②: 진입장벽 제거 포지셔닝 — STATS의 "100% 무료"와 역할 분리
                  { title: '가입 없이 즉시 시작', desc: '소셜 로그인 하나로 바로 사용—진입장벽 없이 누구나 권리를 찾을 수 있습니다.', delay: 0.2 },
