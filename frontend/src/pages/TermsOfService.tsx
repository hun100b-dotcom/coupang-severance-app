  ...
  const sections: TermsSection[] = [
    {
      ...
      content: (
        <div className="space-y-3 text-gray-800 leading-relaxed">
          <p>
            본 약관은 CATCH(이하 "서비스")가 운영하는 퇴직금·실업급여·주휴수당·연차수당 계산기 서비스 및
            채용정보 제공 서비스(이하 "서비스")의 이용과 관련하여 서비스 제공자와 이용자 간의 권리,
            의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
          </p>
          <p>
            CATCH는 일용직 근로자가 복잡한 노동법상 수당 계산을 쉽게 이해할 수 있도록 지원하는
            무료 참고용 계산기 서비스입니다. 본 서비스는 법률 자문 또는 법적 효력이 있는 판단을
            제공하지 않습니다.
          </p>
        </div>
      ),
